            ...
            <header>
                <div className={styles.header_container}>
                    ...
                    <div className={styles.right}>
                                ...
                                <div id='userModal' className={styles.userModal_container}>
                                    ...
                                    <div className={styles.modal_bottom}>
                                        <div className={styles.modal_content}>
                                            ...
                                            <span onClick={this.props.onLogOut}>로그아웃</span>
                                        </div>
                                    </div>
                                </div>
                            </>
                        ...
                        {
                            !this.props.userInfo.uid &&
                            <button className={`${styles.right_btns} ${styles.login_btn} g-signin2`} data-onsuccess="onSignIn" onClick={this.props.onLogIn}>
                                <svg width="24" height="24">

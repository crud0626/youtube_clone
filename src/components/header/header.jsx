...
class Header extends PureComponent {
    ...
    onSearch = (event) => {
        ...
        if (this.inputRef.current.value.search(/\S/g) === 0) {
    ...
    onSignIn = () => {
        authService.login()
        .then(result => {this.props.updateLogin(result.user.uid, result.user.displayName, result.user.photoURL)})
    }

    render() {
        console.log(this.props.userThumbnail);
        return (
            <header>
                <div className={styles.header_container}>
                    ...
                    <div className={styles.center}>
                        <div className={styles.searchbar_container}>
                            <div className={styles.searchbar}>
                                <form className={styles.input_form} onSubmit={this.onSearch}>
                                    <input ref={this.inputRef} placeholder='검색' type="text" onKeyUp={this.handleInput}/>
                                </form>
                                <div className={styles.input_icons_container}>
                                    <button className={styles.input_icon} onClick={this.clickKeyboard}>
                            ...
                            <button className={`${styles.search_icon} ${styles.btns}`} onClick={this.onSearch} title='검색'>
                    ...
                    <div className={styles.right}>
                        ...
                        </button>
                        {
                            ...
                            <>
                                <button className={styles.thumbnail_container} onClick={this.handleModal}>
                                    <img src={this.props.userInfo.url} alt="thumbnail" />
                                </button>
                        ...
                        {
                            !this.props.userInfo.uid &&
                            <button className={`${styles.right_btns} ${styles.login_btn} g-signin2`} data-onsuccess="onSignIn" onClick={this.onSignIn}>
                                <svg width="24" height="24">
